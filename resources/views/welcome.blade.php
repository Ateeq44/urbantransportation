                    ...
                    <div class="col-lg-12">
                        <div class="banner-content">
                            <h1 data-aos="fade-up-right">Safe, Reliable <span> Non-Emergency </span> <br> <span
                                class="home-banner-span-color"> Medical Transportation</span>  in Minneapolis, MN</h1>
                                <p data-aos="fade-up">Urban Transportation Services provides dependable non-emergency medical transportation
                                    in Minneapolis for seniors, individuals with disabilities, and families who need safe, on-time
                                    transportation to medical appointments and essential destinations throughout Minneapolis and
                                surrounding Minnesota communities.</p>
                                <p data-aos="fade-up">Available for you 24 Hours 7 Days a week </p>
                                
                                <ul class="text-white mt-5">
                                    <li>Wheelchair-accessible rear-entry vehicles</li>
                                    <li>Professional and courteous drivers</li>
                                    <li>Serving Minneapolis and the Twin Cities</li>
                                    <li>Safe, reliable, on-time medical transportation</li>
                                </ul>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="about-content">
                            ...
                            <p data-aos="fade-up">
                                Urban Transportation Services is a Minneapolis-based provider of medical transportation in
                                Minneapolis, MN, focused on safety, dignity, and reliability. We specialize in non-emergency
                                medical transportation for individuals who require extra care getting to and from medical
                                appointments, therapy visits, dialysis centers, and essential daily destinations.

                            </p>
                            <p data-aos="fade-up">Our goal is to make medical transportation simple, respectful, and dependable for every client we serve.</p>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="service-head-title">
                            ...
                            <p data-aos="zoom-in">Urban Transportation Services offers NEMT services in Minneapolis designed to support a wide range of <br> mobility needs using clean, well-maintained vehicles operated by trained drivers.
                            </p>
                        </div>
                    </div>
                ...
                <div class="row service-card-row">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="{{ url('service') }}"> 
                            <div class="service-card">
                                <div class="service-icon">
                                    <img src="{{asset('assets/front_end/image/home-service-1.svg')}}" class="img-fluid" alt="">
                                </div>
                                <div class="service-content">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <div class="whychoose-content">
                            ...
                            <h1 data-aos="zoom-in-up">Why Minneapolis Families <span> Choose Urban Transportation Services</span> </h1>


                            <p data-aos="zoom-in-up">Available 24/7 for non-emergency medical transportation</p>
                            <div class="why-choose-points">
                                <p data-aos="zoom-in-up"><i class="fa-solid fa-circle-check"></i> 
                                    Rear-entry wheelchair-accessible vans
                                </p>
                                <p data-aos="zoom-in-up"><i class="fa-solid fa-circle-check"></i> 
                                    Clean, safe, and well-maintained vehicles
                                </p>
                                <p data-aos="zoom-in-up"><i class="fa-solid fa-circle-check"></i> 
                                ...
                                <p data-aos="zoom-in-up"><i class="fa-solid fa-circle-check"></i> 
                                    Focused on safety, dignity, and comfort
                                </p>
                    ...
                    <div class="row how-card-row">
                        ...
                        <div class="col-lg-4">
                            <div class="how-card" data-aos="flip-left">
                                ...
                                <div class="how-card-content">
                                    ...
                                    <p>Request your ride by phone or online</p>
                                </div>
                            </div>
                        </div>
                        <!-- card 1 -->
                        ...
                        <div class="col-lg-4">
                            <div class="how-card" data-aos="flip-left">
                                ...
                                <div class="how-card-content">
                                    <h6>Get Picked Up</h6>
                                    <p>We confirm your trip details and vehicle needs</p>
                                </div>
                            </div>
                        </div>
                        <!-- card 2 -->
                        ...
                        <div class="col-lg-4">
                            <div class="how-card" data-aos="flip-left">
                                ...
                                <div class="how-card-content">
                                    ...
                                    <p>Enjoy safe, comfortable transportation to your destination</p>
                                </div>
                            </div>
                        </div>
                        <!-- card 3 -->
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="commitment-head-title">
                                ...
                                <p data-aos="fade-up">At Urban Transportation Services, safety and accessibility come first. Our vehicles are equipped <br> to support wheelchair, stretcher,  and ambulatory transportation needs, and our <br> drivers are trained to provide respectful, patient-focused service families can trust.</p>
                            </div>
                        </div>
                    </div><!--row-->
