        ...
        <div class="row">
            <div class="col-lg-12 contact-banner-content-col ">
                <div class="contact-banner-content">
                    ...
                    <p data-aos="zoom-in">Request a Quote for Non-Emergency Medical Transportation in Minneapolis, MN</p>
                </div>
            </div>
        </div><!--row-->
            ...
            <div class="col-lg-6" data-aos="fade-right">
                <div class="quote-form-section">
                    ...
                    <div class="container py-2">
                        <h5 data-aos="zoom-in">Quote Instructions</h5>
                        <p data-aos="zoom-in">
                            Please complete the form below with your pickup location, drop-off location, appointment date and time, and mobility needs so we can provide an accurate transportation quote.
                        </p>
                        <form id="bookingForm" method="POST" action="{{ route('booking.store') }}">
                            ...
                            <div class="row mb-4">
                                <!-- Pickup & Dropoff -->
                                <div class="col-md-6">
                                    <label class="form-label">Pickup Location <span class="text-danger">*</span>
                                    </label>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label">Drop-Off Location <span class="text-danger">*</span>
                                    </label>
                            ...
                            <div class="row mb-4">
                                <div class="col-12">
                                    <label class="form-label d-block">Mobility Needs <span class="text-danger">*</span>
                                    </label>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input " type="radio" name="mobility" value="Wheelchair" checked>
                                        <label class="form-check-label">Wheelchair</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input " type="radio" name="mobility" value="Stretcher">
                                        <label class="form-check-label">Stretcher</label>
                                    </div>
                                    <div class="form-check form-check-inline">
                                        <input class="form-check-input " type="radio" name="mobility" value="Ambulatory">
                                        <label class="form-check-label">Ambulatory</label>
                                    </div>
                                </div>
                            </div>
                            <!-- Privacy Policy -->
