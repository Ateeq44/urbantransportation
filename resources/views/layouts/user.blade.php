...
<body>
  ...
  <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5H49HB75" height="0" width="0"
    ...
    <a href="https://wa.me/18328442012" target="_blank">
...
<script src="{{asset('cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/ScrollTrigger.min.js')}}"></script>
    ...
    <!-- <script src="https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.2/gsap.min.js"></script>
      ...
      // Close the mobile navbar when clicking the close button
      closeButton.addEventListener('click', () => {
        navbarCollapse.classList.remove('show');
      });

      // Optional: close the menu if clicked outside of the navbar
    ...
    <!-- JavaScript for Navbar Scroll Effect sticky -->
    <script>
...
<!-- home banner card 4000+ -->
    ...
    <!-- about h6 text -->
    <script>
      gsap.to(".about-content h6", {
        scrollTrigger: {
          trigger: ".about-content h6",
          start: "top 85%",
...
<script>
  var firebaseConfig = {
    apiKey: "AIzaSyAcMgJ3LmlLVbMUxI3UspnjYMvTyZCjpVE",
    authDomain: "test-3bf3c.firebaseapp.com",
    projectId: "test-3bf3c",
    storageBucket: "test-3bf3c.appspot.com",
    messagingSenderId: "282997775835",
    appId: "1:282997775835:web:5f6f0bed139a7e4b941bfe",
    measurementId: "G-P7NBBWYCKH"
  };
  ...
  window.onload = function() {
    ...
    window.recaptchaVerifier = new firebase.auth.RecaptchaVerifier('recaptcha-container', {
      'size': 'normal',  // "normal" makes it visible
