            ...
            <div class="row">
                ...
                <div class="col-lg-7 service-banner-content-col ">
                    <div class="service-banner-content">
                        <h1 data-aos="zoom-in-down">Non-Emergency Medical Transportation in Houston</h1>
                ...
                <div class="col-lg-12">
                    <div class="service-head-tilte">
                        ...
                        <p data-aos="zoom-in">From doctor visits to family gatherings, our rides are designed to meet every
                            need <br> with safety and comfort.</p>
                    </div>
                </div>
            </div><!--row-->
            ...
            <div class="row">
                    ...
                    <a href="{{ url('quote') }}">
                        <div class="service-card h-100">
                            ...
                            <div class="service-card-content ">
                                ...
                                <p>We offer recurring scheduling for a dialysis , physical therapy , chemotherapy,and more -
                                    so you never miss an important visit.</p>
                    ...
                    <a href="{{ url('quote') }}">
                        <div class="service-card h-100">
                            ...
                            <div class="service-card-content">
                                ...
                                <p>Safe and professional transport for patients who must remain lying down.Ideal for
                                    hospital discharges or post-surgical appointments.</p>
                    ...
                    <a href="{{ url('quote') }}">
                        <div class="service-card h-100">
                            ...
                            <div class="service-card-content">
                                ...
                                <p>ADA-Compliant vehicles with secure wheelchair lifts and safety restraints.Our trained
                                    drivers assist every step of the way.</p>
                ...
                <div class="col-lg-4 col-md-6 service-page-card-col">
                    <a href="{{ url('quote') }}">
                        <div class="service-card h-100">
                            <div class="service-card-image">
                                <img src="assets/front_end/image/long.html" class="img-fluid card-img"
                                    alt="">
                            </div>
                            <div class="service-card-content">
