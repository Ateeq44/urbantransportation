            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="about-banner-content">
                        ...
                        <h1 data-aos="zoom-in">Caring Transportation You Can Trust</h1>
            ...
            <div class="row about-page-about-row">
                ...
                <div class="col-lg-6 about-page-about-content-col">
                    <div class="about-page-about-content">
                        ...
                        <p data-aos="zoom-in">Founded with a vision to make safe transportation accessible to everyone,
                            Royalty began as a small family business serving local patients. Over the years, we’ve grown
                            into a trusted service provider for Houston families, hospitals, and care facilities—always
                            guided by compassion, professionalism, and a commitment to care.</p>
                ...
                <div class="col-lg-3 col-md-6 values-card-col">
                    <div class="values-card h-100" data-aos="flip-left">
                        ...
                        <div class="values-card-content">
                            ...
                            <p>Clean, spacious vehicles designed to make every trip stress-free.</p>
                        </div>
                    </div>
                </div>
                <!-- card 1 lg3 -->
                ...
                <div class="col-lg-3 col-md-6 values-card-col">
                    <div class="values-card h-100" data-aos="flip-right">
                        ...
                        <div class="values-card-content">
                            ...
                            <p>Clean, spacious vehicles for a stress-free ride.</p>
                        </div>
                    </div>
                </div>
                <!-- card 1 lg3 -->
            ...
            <div class="row values-card-row">
                ...
                <div class="col-lg-3 col-md-6 values-card-col">
                    <div class="values-card h-100" data-aos="flip-left">
                        ...
                        <div class="values-card-content">
                            ...
                            <p>Text: Reliable pickups and drop-offs, always on time.</p>
                        </div>
                    </div>
                </div>
                <!-- card 1 lg3 -->
                ...
                <div class="col-lg-3 col-md-6 values-card-col">
                    <div class="values-card h-100" data-aos="flip-right">
                        ...
                        <div class="values-card-content">
                            <h6>Fair & Clear</h6>
                            <p>Fair pricing with no hidden costs, giving quality service.</p>
                        </div>
                    </div>
                </div>
                <!-- card 1 lg3 -->
                ...
                <div class="col-lg-6 vision-content-col" data-aos="fade-left">
                    <div class="vision-content-card h-100">
                        <div class="vision-content ">
                            <h6>Our Vision</h6>
                            <h1>Driving a Future of Care</h1>
                            <p>Our vision is to redefine non-emergency medical transportation by making it safer, more
                                accessible, and more compassionate for every rider. We believe that every journey should
                                support independence, dignity, and peace of mind—helping to build a stronger, healthier
                                Houston community.</p>
                        </div>
                    </div>
                ...
                <div class="col-lg-6 vision-content-col mission-content-col" data-aos="fade-right">
                    <div class="vision-content-card h-100">
                        <div class="vision-content ">
                            ...
                            <p>Our mission is to deliver safe, reliable, and affordable transportation for all non-emergency
                                needs. With CPR-certified drivers, ADA-compliant vehicles, and 24/7 availability, we are
                                dedicated to ensuring every ride is comfortable, stress-free, and guided by genuine
                                compassion.</p>
                        </div>
                    </div>
